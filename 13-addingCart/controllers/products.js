...
exports.listProduct = async (request, response, next) => {
    try {
...
exports.listProductUser = async (request, response, next) => {
    try {
        // Read the HTML file
        const htmlData = await fs.readFile('./views/listed-product.html', 'utf-8');
...
exports.pDescription = async (request, response) => {
    try {
        ...
        const data = await fs.readFile('./views/pDescription.html', 'utf-8');
